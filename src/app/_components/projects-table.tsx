    ...
    return (
      <div className="text-center py-8">
        <p className="text-gray-600">
          No projects found, I must be busy or working on the database!
        </p>
      </div>
    );
  }
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="border-b border-gray-200 dark:border-gray-700">
              <th className="text-left py-4 px-2 font-semibold text-gray-900 dark:text-gray-100">
                Project
              </th>
              <th className="text-left py-4 px-2 font-semibold text-gray-900 dark:text-gray-100">
                Problem Solved
          ...
          >
            <div className="space-y-3">
              ...
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                ...
                <span
                  className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium self-start ${statusColors[project.status]}`}
                >
                  {project.status}
                </span>
              </div>
